...
<div class="p-4 w-full overflow-x-hidden flex flex-col gap-5">
  <div class="flex flex-row justify-between">
    <h1 class="font-medium text-4xl my-2">Edit Kategori</h1>
  ...
  <form action="/dashboard/kategori/{{ $data->id }}" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-col gap-2 mb-5">
      ...
      <input type="text" class="rounded-md border border-gray-200 @error('nama') !border-red-300 @enderror" name="nama" id="kategori" value="{{ old(  'nama', $data->nama ) }}" onkeyup="getSlug()">
      @error('nama')
      ...
      @enderror
        ...
        <div class="flex flex-col gap-2 mb-5">
          ...
          <input type="text" class="rounded-md border border-gray-200 @error('slug') !border-red-300 @enderror" name="slug" id="slug" value="{{ old('slug', $data->slug ) }}">
          @error('slug')
            <div class="flex flex-row text-red-600 mt-1 items-center gap-1">
            <svg class="w-7 h-7" width="256px" height="256px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#dc2626" stroke-width="0.00024000000000000003">
              <g id="SVGRepo_iconCarrier"> 
    ...
    <div class="flex flex-col gap-2 mb-5">
      ...
      <textarea name="deskripsi" id="editor" class="rounded-md border-gray-200">{{ old('deskripsi', $data->deskripsi ) }}  </textarea>
      @error('deskripsi')
        <div class="flex flex-row text-red-600 mt-1 items-center gap-1">
          <svg class="w-7 h-7" width="256px" height="256px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#dc2626" stroke-width="0.00024000000000000003">
            <g id="SVGRepo_iconCarrier"> 
