...
<div class="p-4 w-full overflow-x-hidden flex flex-col gap-5">
  <div class="flex flex-row justify-between">
    <h1 class="font-medium text-4xl my-2">Slide Baru</h1>
  ...
  <form action="/dashboard/slide" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-col gap-2 mb-5">
      ...
      <input type="text" class="rounded-md border border-gray-200 @error('judul') !border-red-300 @enderror" name="judul" id="judul" value="{{ old('judul') }}">
      @error('judul')
    ...
    <div class="flex flex-col gap-2 mb-5">
      ...
      <textarea name="kutipan" id="editor" class="rounded-md border-gray-200">{{ old('kutipan') }}</textarea>
      @error('kutipan')
        <div class="flex flex-row text-red-600 mt-1 items-center gap-1">
          <svg class="w-7 h-7" width="256px" height="256px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#dc2626" stroke-width="0.00024000000000000003">
            <g id="SVGRepo_iconCarrier"> 
